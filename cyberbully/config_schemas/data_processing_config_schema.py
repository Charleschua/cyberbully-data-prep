...
from cyberbully.config_schemas.dask_cluster import dask_cluster_schema
from cyberbully.config_schemas.data_processing import dataset_cleaners_schema, dataset_readers_schema
...
class DataProcessingConfig:
    ...
    dvc_remote_repo: str = "https://github.com/emkademy/cyberbully-data.git"
    dvc_data_folder: str = "data/raw"
    github_user_name: str = "emkademy"
    github_access_token_secret_id: str = "cyberbully-data-github-access-token"
